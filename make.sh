...
# the fastest.
gcc -Os -std=c99 -c pocketfft-master/pocketfft.c -o pocketfft.o
...
x86_64-w64-mingw32-gcc -O2 -std=c99 -c pocketfft-master/pocketfft.c -o pocketfft-win.o -D__USE_MINGW_ANSI_STDIO=0
